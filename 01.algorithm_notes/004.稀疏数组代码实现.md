...
- [首先创建棋盘数组, 并进行输出棋盘数组](#首先创建棋盘数组-并进行输出棋盘数组)
    - [代码实现](#代码实现)
    - [输出结果](#输出结果)
- [然后将棋盘数组转化为稀疏数组, 并输出稀疏数组](#然后将棋盘数组转化为稀疏数组-并输出稀疏数组)
    - [代码实现](#代码实现)
    - [输出结果](#输出结果)
- [最后将稀疏数组还原成原始二维数组](#最后将稀疏数组还原成原始二维数组)
    - [代码实现](#代码实现)
    - [输出结果](#输出结果)
- [全篇完整代码](#全篇完整代码)
...
<a id="markdown-首先创建棋盘数组-并进行输出棋盘数组" name="首先创建棋盘数组-并进行输出棋盘数组"></a>

****
### 代码实现
<a id="markdown-代码实现" name="代码实现"></a>
```java
/**
...
****
### 输出结果
<a id="markdown-输出结果" name="输出结果"></a>
如下图所示, 这就是原始的二维棋盘数组  
![棋盘数组输出](../99.images/2020-04-14-10-04-49.png)


## 2. 然后将棋盘数组转化为稀疏数组, 并输出稀疏数组
<a id="markdown-然后将棋盘数组转化为稀疏数组-并输出稀疏数组" name="然后将棋盘数组转化为稀疏数组-并输出稀疏数组"></a>
...
## 3. 最后将稀疏数组还原成原始二维数组
<a id="markdown-最后将稀疏数组还原成原始二维数组" name="最后将稀疏数组还原成原始二维数组"></a>
...
## 4. 全篇完整代码
<a id="markdown-全篇完整代码" name="全篇完整代码"></a>
```java
